...
import githubcat.BasicMod;
import githubcat.util.CardStats;
import githubcat.util.TriFunction;
...
import static githubcat.util.GeneralUtils.removePrefix;
import static githubcat.util.TextureLoader.getCardTextureString;
