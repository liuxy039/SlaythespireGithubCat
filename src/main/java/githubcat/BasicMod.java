...
public class BasicMod implements
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard(new githubcat.cards.ScrumMaster());
        BaseMod.addCard(new githubcat.cards.Firewall());
        BaseMod.addCard(new githubcat.cards.InternetSpirit());
        BaseMod.addCard(new githubcat.cards.Deadline());
        BaseMod.addCard(new githubcat.cards.WorkFromHome());
        BaseMod.addCard(new githubcat.cards.ScienceSurf());
        BaseMod.addCard(new githubcat.cards.TransactionIsolation());
        BaseMod.addCard(new githubcat.cards.IndianDev());
        BaseMod.addCard(new githubcat.cards.DBDrop());
        BaseMod.addCard(new githubcat.cards.OpenSource());
        BaseMod.addCard(new githubcat.cards.CodeReview());
        BaseMod.addCard(new githubcat.cards.Hotfix());
        BaseMod.addCard(new githubcat.cards.GarbageCollect());
        BaseMod.addCard(new githubcat.cards.EmergencyPatch());
        BaseMod.addCard(new githubcat.cards.PacketStorm());
        BaseMod.addCard(new githubcat.cards.PortableRouter());
        BaseMod.addCard(new githubcat.cards.HackAttack());
        BaseMod.addCard(new githubcat.cards.ResourceSched());
        BaseMod.addCard(new githubcat.cards.IdleRecycle());
        BaseMod.addCard(new githubcat.cards.StorageReload());
        BaseMod.addCard(new githubcat.cards.Ransomware());
    }
